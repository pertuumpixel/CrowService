package com.github.pertuumpixel.crowservice.common.item.crafting.recipe;
...
public class PressingRecipe extends SingleItemRecipe {
    ...
    public PressingRecipe(ResourceLocation recipeId,
                          ...
                          ItemStack result) {
        super(RecipesInit.Types.PRESSING, RecipesInit.Serializers.PRESSING.get(), recipeId, "", ingredient, result);
    }
