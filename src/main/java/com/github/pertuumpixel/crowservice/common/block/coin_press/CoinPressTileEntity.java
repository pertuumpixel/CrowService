...
import com.github.pertuumpixel.crowservice.core.init.RecipesInit;
import com.github.pertuumpixel.crowservice.core.init.TileEntityTypesInit;
...
public class CoinPressTileEntity extends LockableTileEntity implements ISidedInventory, ITickableTileEntity {
    ...
    public CoinPressTileEntity() {
        super(TileEntityTypesInit.COIN_PRESS.get());
    ...
    public PressingRecipe getRecipe() {
        ...
        return this.level.getRecipeManager().getRecipeFor(RecipesInit.Types.PRESSING, this, this.level).orElse(null);
    }
    ...
    protected ITextComponent getDefaultName() {
        return new TranslationTextComponent("container.crowservice.coin_press");
    }

    @Override
    protected Container createMenu(int id, PlayerInventory playerInventory) {
        return new CoinPressContainer(id, playerInventory, this, this.fields);
    }
